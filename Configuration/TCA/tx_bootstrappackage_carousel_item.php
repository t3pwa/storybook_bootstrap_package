...
return [
    'ctrl' => [
        ...
        'typeicon_classes' => [
            ...
            'content' => 'content-bootstrappackage-carousel-item-content',
        ]
    ],
    'interface' => [
        'showRecordFieldList' => '
    ...
    'types' => [
        ...
        'content' => [
            ...
            'showitem' => '
                --palette--;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:palette.general;general,
                header;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:header.ALT.html_formlabel,
                content_elements;LLL:EXT:frontend/Resources/Private/Language/locallang_ttc.xlf:header.ALT.html_formlabel,
             ',
        ...
        'item_type' => [
            ...
            'config' => [
                ...
                'items' => [
                    ...
                    [
                        '(new item type) Content',
                        'tt_content',
                        'content-bootstrappackage-carousel-item-content'
