...
if (!is_array($GLOBALS['TCA']['tt_content']['types']['carousel_fullscreen_override'] ?? false)) {
    $GLOBALS['TCA']['tt_content']['types']['carousel_fullscreen_override'] = [];
}
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    [
        ...
        '(Override) Carousel Fullscreen',
//        'carousel_fullscreen',
        'carousel_fullscreen_override',
...
$GLOBALS['TCA']['tt_content']['types']['carousel_fullscreen_override'] = array_replace_recursive(
    // $GLOBALS['TCA']['tt_content']['types']['carousel_fullscreen'],
    $GLOBALS['TCA']['tt_content']['types']['carousel_fullscreen_override'],
    [
        'showitem' => '
