...
$GLOBALS['TCA']['tt_content']['columns']['background_color_class']['config']['items'][] = [
    '-- None --', ''
];
...
/* Frame Layout Overrides */
$GLOBALS['TCA']['tt_content']['columns']['frame_layout']['config']['items'][] = [
    '-- None --', ''
];

$GLOBALS['TCA']['tt_content']['columns']['frame_layout']['config']['items'][] = [
    '[Custom Frame Layout 1]]', 'custom-frame-layout-1'
];

$GLOBALS['TCA']['tt_content']['columns']['frame_layout']['config']['items'][] = [
    '[Custom Frame Layout 2]]', 'custom-frame-layout-2'
];

$GLOBALS['TCA']['tt_content']['columns']['frame_class']['config']['items'][] = [
    '[Custom Frame Class 1]]', 'custom-frame-class-1'
];
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'frame_class',
    [
        'LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:field.frame_options.custom_frame_class_2',
        'custom_frame_class_2'
    ],
    (string) 126,
    'after'
);
...
\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::addTcaSelectItem(
    ...
    'frame_layout',
    [
        'LLL:EXT:bootstrap_package/Resources/Private/Language/Backend.xlf:field.frame_options.custom_frame_layout_2',
        'custom_frame_layout_2'
    ],
    (string) 126,
    'after'
);
...
/*
$GLOBALS['TCA']['tt_content']['columns']['background_color_class'] = array_replace_recursive(
