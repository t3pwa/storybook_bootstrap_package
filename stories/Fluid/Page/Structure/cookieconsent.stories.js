...
export default {
    title: 'Page/Structure/CookieConsent',
    tags: ['autodocs'],

//    public/typo3conf/ext/bootstrap_package/Resources/Private/Partials/Page/Structure/CookieConsent.html
    /*

        cookieconsent.common.dismiss
        cookieconsent.common.allow
        cookieconsent.common.deny
        cookieconsent.common.link
        theme.cookieconsent.content.href
        theme.cookieconsent.layout
        theme.cookieconsent.type
        theme.cookieconsent.position
        theme.cookieconsent.revokable
        theme.cookieconsent.static
        theme.cookieconsent.location
...
export const Template = (args) => FluidTemplate({
    ...
    template: '',
    partial: 'Page/Structure/CookieConsent',
    section: '',
    args
});
