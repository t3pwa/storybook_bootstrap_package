...
export default {
    title: 'Page/Structure/SocialLinks',
    tags: ['autodocs'],
    argTypes: {
        /*
        page: {
...
export const Template = (args) => FluidTemplate({
    ...
    template: '',
    partial: 'Page/Structure/SocialLinks',
    section: '',
    args
});
    ...
    theme: {
        ...
        socialmedia: {
            ...
            channels: {
                facebook: {
                    label: "Facebook",
                    url: "https://facebook.com/init"
                },
                instagram: {
                    label: "Instagram",
                    url: "https://instagram.com/typo3"
                },
                twitter: {
                    label: "Twitter",
                    url: "https://twitter.com/init"
                },
                mastodon: {
                    label: "Mastodon",
                    url: "https://mastodon.com/@init"
                }
