...
Tertiary.args = {
    ...
    positionClass : 'right',
    link : 'https://www.init.de/thema/typo3-public-sector',
    label: 'Tertiary Header Label',

    data: {
        header_layout: 4,
        header: "[data.header] TYPO3 für Verwaltungen und Behörden \n " +
            "\n\r(CMS-Projekte einfach umgesetzt) ",
        header_position: "above",
        subheader: "[Header/All/Subheader] \n CMS-Projekte einfach umgesetzt ",
        date: "2024-04-11",
        layout: 3,
